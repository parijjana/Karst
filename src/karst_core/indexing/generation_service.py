...
from src.karst_core.parser.discovery import DiscoveryLimits, discover_snapshots
from src.karst_core.indexing.models import (
    DiagnosticSeverity, IndexCounts, IndexDiagnostic, IndexResult, IndexStatus,
    ParseStatus,
)
from src.karst_core.indexing.plan import ManifestRecord, PlanAction, build_manifest_plan
from src.karst_core.indexing.repository import GenerationRepository
from src.karst_core.parser import CodeParser
...
class IncrementalIndexService:
    ...
    def _manifest(db: Database, generation_id: int) -> tuple[ManifestRecord, ...]:
        from src.karst_core.indexing.identity import FileCandidate
